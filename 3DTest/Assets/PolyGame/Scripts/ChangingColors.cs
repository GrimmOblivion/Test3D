...
public class ChangingColors : MonoBehaviour
{
    ...
    void Start()
    {
       // GetComponent<SpriteRenderer>().color = new Color(255f, 255f, 255f);
        GetComponent<Light>().color = new Color(225f, 225f, 255f);
    }
    ...
    void Update()
    {
        ...
        if (num == 1)
            ...
            GetComponent<Light>().color = GetComponent<Light>().color = Color.green;

        }
        if (num == 2)
            {
             //   GetComponent<SpriteRenderer>().color = GetComponent<SpriteRenderer>().color = Color.blue;
            GetComponent<Light>().color = GetComponent<Light>().color = Color.blue;

        }
        if (num == 3)
        {             //   GetComponent<SpriteRenderer>().color = GetComponent<SpriteRenderer>().color = Color.red;

            GetComponent<Light>().color = GetComponent<Light>().color = Color.red;
